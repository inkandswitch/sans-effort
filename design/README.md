...
flowchart BT
    ...
    class effects,tokio_crate planned
```
...
- _A small, stable mechanism._ Opinions (which capabilities exist, how they run on tokio) live in separate crates with their own versions.
