...
What a skin built on `sans_effort_host` exports, and what a foreign host may assume. A host that assumes this and nothing else is generic over routines: it can drive any effect routine whose skin speaks it, given only the routine's tag table.
